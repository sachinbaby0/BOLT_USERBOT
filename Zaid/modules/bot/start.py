...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡𝗗𝗘𝗣𝗟𝗢𝗣𝗘𝗥⚡", url="t.me/your_alpha_baby"),
            ],
            [
                InlineKeyboardButton("⚡𝗨𝗣𝗗𝗔𝗧𝗘𝗦⚡", url="t.me/purvi_updates"),
            ],
            [
                InlineKeyboardButton("⚡𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡", url="t.me/purvi_support"),
            ],
            ]
